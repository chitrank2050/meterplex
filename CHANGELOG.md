...
- Update linting pipeline to run TypeScript and Markdown checks and disable Knip
- Add pnpm installation step to git-release workflow
- Update changelog generation to use git-cliff output directly instead of CLI command
- Enforce Node 24 for GitHub Actions in release and CI workflows
- Update CHANGELOG.md (#64)
- Streamline changelog generation using git-cliff-action and clean up temporary files
- Pin GitHub Actions to specific commit hashes for security
- Update GitHub Actions dependencies to latest versions
- Disable persist-credentials in all GitHub Actions checkout steps
- Pass git-cliff output to gh release via environment variable
- Update orhun/git-cliff-action action to v4.7.1 (#71)
- Update dependency knip to v6.6.3 (#69)

### ⚙️ Miscellaneous Tasks

- Merge branch 'main' of github.com:chitrank2050/meterplex

### 🏗️ Build

- Bump the all-actions group across 1 directory with 3 updates (#72)

### 📚 Documentation

- Add zizmor installation guide and security audit documentation

### 🚀 Features

- Add workflow_dispatch support to trigger releases with custom tags
- Add zizmor linting for GitHub Actions to project scripts and lefthook configuration

### 🚜 Refactoring

- Update release workflow to generate changelog via automated PR instead of direct commit
- Replace action-gh-release with GitHub CLI for release creation
...
- Replace em-dashes with hyphens in documentation and DTO comments
...
- Merge pull request #7 from chitrank2050/dependabot/npm_and_yarn/patch-and-minor-9be03812ba

build(deps): bump the patch-and-minor group across 1 directory with 12 updates
...
- Merge pull request #1 from chitrank2050/dependabot/npm_and_yarn/npm_and_yarn-66413a1f6e

chore(deps): bump picomatch from 2.3.1 to 2.3.2 in the npm_and_yarn group across 1 directory
- Merge pull request #2 from chitrank2050/dependabot/npm_and_yarn/npm_and_yarn-6c4c142770

build(deps): bump brace-expansion from 1.1.12 to 1.1.13 in the npm_and_yarn group across 1 directory
- Merge branch 'main' of github.com:chitrank2050/meterplex

### 🎨 Styling

- Standardize configuration files by converting double quotes to single quotes
...
- Refactor CI pipeline, update dependencies, and upgrade Python and Node.js versions
...
- Initialize NestJS project with basic application structure, configurations, and testing setup.

### 🎨 Styling

- Format prisma schema generator block and add newline to app module.
